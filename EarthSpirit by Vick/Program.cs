namespace EarthSpirit
{
    ...
    internal class EarthSpiritController
    {
        private static readonly Menu Menu = new Menu("EarthSpirit", "EarthSpirit", true, "npc_dota_hero_earth_spirit", true);

        private static bool Active, CastW, CastE, CastQ;

        private static Hero e, me;
        static void Game_OnUpdate(EventArgs args)
        {
            if (!Game.IsInGame || me == null || me.ClassID != ClassID.CDOTA_Unit_Hero_EarthSpirit || Game.IsWatchingGame) return;
        ...
        private static void Others(EventArgs args)
        {
        ...
        {
            if (ObjectManager.LocalHero.ClassID != ClassID.CDOTA_Unit_Hero_EarthSpirit) return;
            ...
            Menu.AddItem(new MenuItem("others", "Drawing Target Maker").SetValue(true));
