...
namespace DotaAllCombo.Heroes
{
    ...
    internal class TuskController : Variables, IHeroController
    {
		...
		public void Combo()
		{
			...
			var SiglControl = menu.Item("SiglControl").IsActive();
			...
			if (Active && target.IsAlive && !target.IsInvul() && !target.IsIllusion)
			{
				...
				var linkens = target.HasModifier("modifier_item_spheretarget") ||
							  target.Inventory.Items.Any(x => x.Name == "item_sphere");
